...
@RoutePage()
class InviteToSingScreen extends StatefulWidget {
  const InviteToSingScreen({super.key});
  @override
  State<InviteToSingScreen> createState() => _InviteToSingScreenState();
}

class _InviteToSingScreenState extends State<InviteToSingScreen> {
