...
@RoutePage()
class DocumetDateilScreen extends StatefulWidget {
  const DocumetDateilScreen({super.key});
  @override
  State<DocumetDateilScreen> createState() => _DocumetDateilScreenState();
}

class _DocumetDateilScreenState extends State<DocumetDateilScreen> {
  @override
