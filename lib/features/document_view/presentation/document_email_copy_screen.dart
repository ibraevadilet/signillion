...
@RoutePage()
class EmailACopyScreen extends StatefulWidget {
  const EmailACopyScreen({super.key});
  @override
  State<EmailACopyScreen> createState() => _InviteToSingPageState();
}

class _InviteToSingPageState extends State<EmailACopyScreen> {
